...
class PatientCounsellorClerkingNotes extends Model
{
    ...
    protected $fillable = ['id','appointment_details_id', 'added_by','patient_mrn_id','clinical_summary',
    ...
    'medication_des','status','additional_diagnosis', 'additional_subcode','additional_code_id','created_at','is_deleted'];
}