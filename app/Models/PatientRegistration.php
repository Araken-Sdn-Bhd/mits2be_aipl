...
class PatientRegistration extends Model
{
    ...
    protected $fillable = ['added_by', 'salutation_id', 'name_asin_nric', 'citizenship', 'nric_type', 'nric_no'
    , 'passport_no','expiry_date', 'country_id', 'sex', 'birth_date', 'age', 'mobile_no', 'house_no','added_by'
    , 'hospital_mrn_no', 'mintari_mrn_no', 'services_type', 'referral_type', 'referral_letter', 'address1'
    ,'address2', 'address3', 'state_id', 'city_id', 'postcode', 'race_id', 'religion_id','marital_id',
    ...
    'other_allergy', 'other_description','status'];
