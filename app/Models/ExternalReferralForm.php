...
class ExternalReferralForm extends Model
{
    ...
    protected $fillable = ['added_by', 'patient_mrn_id','history','examination','diagnosis','result_of_investigation','summary',
    ...
    'medication_des','name','designation','hospital','status','created_at'];
