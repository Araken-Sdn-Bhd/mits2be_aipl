...
class SeProgressNote extends Model
{
    ...
    'services_id', 'code_id', 'sub_code_id', 'complexity_service', 'outcome', 'additional_code_id', 'additional_diagnosis', 'additional_subcode',
    'medication', 'restart', 'status','created_at','is_deleted'];
}
