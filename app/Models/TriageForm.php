...
class TriageForm extends Model
{
    ...
    'risk_history_neglect', 'risk_history_suicidal_idea', 'risk_history_homicidal_idea', 'risk_history_homicidal_attempt', 'risk_history_aggressive_idea',
    ...
    'treatment_checked','treatment_given_appointment','treatment_given_regular','placement_referred','placement_discharge','screening_id',
