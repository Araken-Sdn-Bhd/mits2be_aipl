...
class PatientAppointmentDetailsController extends Controller
{
    ...
    public function fetchPatientStaffById(Request $request)
    {
        ...
        $tabData = [
            ...
            array("tab" => "patient_care_paln", "col" => "type_of_diagnosis", "cos" => "category_of_services", "cs" => "complexity_of_services", "outcome" => "outcome", "ls" => "location_of_service", "type" => "PatientCarePlanAndCaseReviewForm", "id" => "id", "patient_mrn_id" => "patient_id"),
